import { LetterText, LinkedinIcon, Mail } from "lucide-react";
import Link from "next/link";

export function CardAnimatedContactMe() {
    return (
        <div className="relative w-full max-w-5xl mx-auto overflow-hidden rounded-[2rem] bg-linear-to-br from-orange-600/70 to-amber-400/70  p-4 border border-white/5 backdrop-blur-lg min-h-[400px]">
