    ...
    return (
        <div className="relative w-full mx-auto overflow-hidden rounded-lg rounded-tl-[50px] rounded-bl-[50px] 
            ...
            <div className="w-full mb-32">
                <h2 className="text-4xl font-light w-full max-w-[80%] leading-12">Atualmente estou trabalhando na <span className="text-white font-bold">HVEX</span></h2>
                <p className="text-md font-extralight leading-8 max-w-[80%] mt-8">
