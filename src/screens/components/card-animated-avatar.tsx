export function CardAnimatedAvatar() {
    return (
        <div className="relative w-full max-w-5xl mx-auto overflow-hidden rounded-[2rem] bg-[#131311] p-12 border border-white/5 backdrop-blur-lg min-h-[400px] rounded-bl-lg  rounded-tl-[50px] rounded-br-[50px]">
