    ...
    return (
        <div className="flex flex-col gap-4">
            ...
            <p className="text-base font-extralight leading-9 max-w-[60%]">
                Estou aprimorando minhas habilidades em React, TypeScript e Next.js, com foco em performance no front-end. Além disso, estou explorando novas tecnologias e ferramentas para melhorar minha produtividade e qualidade de código.
            </p>
        </div>
    )
}
...
export function CardSkills() {
    return (
        <div className="relative w-full max-w-5xl overflow-hidden h-auto flex flex-col gap-4 rounded-[2rem] bg-[#131311] p-12 border border-white/5 backdrop-blur-lg">
